...
(function (global) {
  ...
  This is a specification for the programming language JavaScript.
  It defines an API that defines code modules and their dependencies,
  and loads them asynchronously if desired.
  Implementations of AMD provide the following benefits:
  - Website performance improvements,
    since AMD implementations load smaller JavaScript files, and only when they are needed.
  - Fewer page errors,
    since AMD implementations allow developers to define dependencies
    that must load before a module is executed, so the module does not
    try to use outside code that is not available yet.

  Source: https://en.wikipedia.org/wiki/Asynchronous_module_definition
  */
